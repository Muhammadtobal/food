...
export class CreateTables1748777353175 implements MigrationInterface {
    name = 'CreateTables1748777353175'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`category\` CHANGE \`image\` \`image\` varchar(255) NOT NULL`);
