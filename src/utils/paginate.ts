...
import { FindManyOptions, FindOptions, FindOptionsWhere, ObjectLiteral, Repository } from 'typeorm';
...
export async function paginate<T extends ObjectLiteral>(
  ...
  try {
    ...
    console.log(`TypeORM Query Params: skip=${skip}, limit=${limitNumber}, allData=${allData}`);
